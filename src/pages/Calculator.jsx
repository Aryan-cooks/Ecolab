    ...
    <main className="flex-1 overflow-y-auto p-4 md:p-6 grid-line relative min-h-screen">
      ...
      <div className="grid grid-cols-12 gap-4 max-w-[1400px] mx-auto">
        ...
        <section className="col-span-12 lg:col-span-6 border border-outline bg-surface p-4 relative">
          <div className="absolute top-0 right-0 p-2 text-[10px] text-outline">
            MOD_01
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1">
              ...
              >
                ...
                <option value="electricCar">
                  Electric 4-Wheeler (0.05 kg/km)
                </option>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                value={weeklyKm}
                onChange={(e) =>
                  setWeeklyKm(Math.max(0, parseInt(e.target.value) || 0))
                }
                className="w-full text-sm py-2 px-3 bg-surface border border-outline focus:border-primary text-primary focus:outline-none"
              />
            </div>
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setTransitPercent(parseInt(e.target.value) || 0)
                }
            ...
            <div className="col-span-2 mt-2">
              <div className="h-24 w-full border border-outline/50 bg-black/40 flex items-center justify-center relative overflow-hidden">
                ...
                <span className="text-[9px] text-primary/40 uppercase">
                  Aero_Dynamics_Pulse
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1 col-span-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setLocalFoodPercent(parseInt(e.target.value) || 0)
                }
                className="w-full h-1 bg-outline appearance-none cursor-pointer accent-primary mt-3"
              />
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  value={monthlyKwh}
                  onChange={(e) =>
                    setMonthlyKwh(Math.max(0, parseInt(e.target.value) || 0))
                  }
                  className="w-full text-sm py-2 px-3 bg-surface border border-outline focus:border-primary text-primary focus:outline-none"
                />
              </div>
            ...
            <div className="col-span-1 sm:col-span-2 sm:border-l border-outline sm:pl-6 pt-4 sm:pt-0">
              ...
              <div className="mt-4 grid grid-cols-2 gap-2">
                <div className="bg-black/40 border border-outline p-2">
                  <div className="text-[8px] text-on-surface/50 uppercase">
                    HVAC_LOAD_EST
                  </div>
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                value={clothingSpend}
                onChange={(e) =>
                  setClothingSpend(Math.max(0, parseInt(e.target.value) || 0))
                }
                className="w-full text-sm py-2 px-3 bg-surface border border-outline focus:border-primary text-primary focus:outline-none"
              />
            </div>
        ...
        <section className="col-span-12 border-2 border-primary bg-black p-6 relative overflow-hidden">
          <div className="absolute top-0 right-0 p-3 bg-primary text-background font-black text-[10px]">
            REAL_TIME_ANALYSIS
          </div>
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            ...
            <div className="flex flex-wrap md:flex-nowrap gap-6 md:gap-12 text-left md:text-right w-full md:w-auto mt-4 md:mt-0">
              ...
              <div className="flex-1 md:flex-none">
                <div className="text-[10px] text-accent-blue uppercase">
                  Green_Score
                </div>
                <div className="text-xl font-bold">
                  {liveResults.greenScore}
                </div>
              </div>
      ...
      <footer className="mt-8 flex flex-col sm:flex-row justify-between items-center border-t border-outline pt-4 gap-4">
        ...
        <div className="text-[10px] uppercase flex gap-4 opacity-50">
          ...
          <span className="text-alert-red hover:underline cursor-pointer">
            Abort_Process
          </span>
        </div>
      </footer>
