...
export default function Chat() {
  ...
  const quickCommands = [
    {
      label: "HELP_DECODE_TRANSPORT",
      text: "How can I reduce my transportation emissions? Give me specific options.",
    },
    {
      label: "ADVISE_ON_DIET",
      text: "What dietary changes have the biggest carbon impact in India?",
    },
    {
      label: "EXPLAIN_GRID_BASES",
      text: "Why is electricity emission factor so high in India?",
    },
    {
      label: "GET_RATING_RECOMMENDATIONS",
      text: "Analyze my Green Score and tell me how to get to Guardian tier.",
    },
  ];
    ...
    <main className="p-4 md:p-8 min-h-screen flex flex-col justify-between max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          ...
          {sending && (
            <div className="flex items-start flex-col animate-pulse">
              <div className="text-[8px] opacity-50 uppercase mb-1">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          <div className="text-[8px] uppercase text-neon-green/50 font-bold">
