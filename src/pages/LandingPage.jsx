...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      if (index < LOGS_LIST.length) {
        setBootLogs((prev) => [...prev, LOGS_LIST[index]]);
        index++;
      } else {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-6 bg-transparent relative overflow-hidden">
      <BorderGlow
        ...
        className="w-full max-w-2xl z-10 border-2 border-neon-green backdrop-blur-sm"
      >
        <div className="p-6 font-mono text-xs relative select-none">
          ...
          <div className="flex items-center gap-2 mb-6 border-b border-neon-green/30 pb-4">
            ...
            <span className="font-bold text-lg tracking-widest text-neon-green">
              <DecryptedText text="ECO-LAB_V2.4" animateOn="view" revealDirection="center" />
            </span>
          </div>
          ...
          <div className="space-y-1 min-h-[160px] text-neon-green mb-8">
            ...
            {bootLogs.length === LOGS_LIST.length && <div className="animate-pulse">_</div>}
          </div>

          {bootLogs.length === LOGS_LIST.length && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-2 gap-4 border-t border-b border-neon-green/30 py-6">
                ...
                <div className="border border-neon-green/30 p-3 bg-black/40">
                  ...
                  <p className="text-[10px] opacity-75 leading-relaxed">
                    Personalized optimization suggestions and synchronization chats.
                  </p>
                </div>
                <div className="border border-neon-green/30 p-3 bg-black/40">
                  <div className="font-bold text-neon-amber text-[10px] mb-1">
                  ...
                  <p className="text-[10px] opacity-75 leading-relaxed">
                    Telemetry metrics compared against national averages (India 2.0t).
                  </p>
                </div>
                <div className="border border-neon-green/30 p-3 bg-black/40">
                  <div className="font-bold text-neon-amber text-[10px] mb-1">
                  ...
                  <p className="text-[10px] opacity-75 leading-relaxed">
                    Level scaling, streaks, and milestone badges (Seedling to Guardian).
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  <DecryptedText
                    text={user ? "ENTER_COMMAND_CENTER" : "CONNECT_TO_NODE"}
                    animateOn="hover"
                  />
                </button>
                ...
                {!user && (
                  <div className="text-[9px] text-center text-neon-green/55">
                    clearance status: unauthenticated. default access keys will generate simulated
                    node.
                  </div>
                )}
              </div>
