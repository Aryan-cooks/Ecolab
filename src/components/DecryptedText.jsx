...
export default function DecryptedText({
  ...
  const triggerHoverDecrypt = useCallback(() => {
    ...
    const now = Date.now();
    // 1000ms cooldown to prevent rapid trigger loops due to layout shifts/transitions
    if (now - lastStartRef.current < 1000) return;
  ...
  useEffect(() => {
    ...
    intervalRef.current = setInterval(() => {
      if ((animateOn === "hover" || animateOn === "inViewHover") && containerRef.current) {
