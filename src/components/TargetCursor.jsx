  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      corners.forEach((corner, i) => {
        ...
        if (strength >= 0.99) {
          if (parallaxOn) {
            // Smooth lerp for parallax lag (factor of 0.15 gives ~200ms lag)
            finalX = currentX + (targetX - currentX) * 0.15;
            finalY = currentY + (targetY - currentY) * 0.15;
          } else {
          ...
          // Lock-on transition using activeStrength
          finalX = currentX + (targetX - currentX) * strength;
          finalY = currentY + (targetY - currentY) * strength;
        }
